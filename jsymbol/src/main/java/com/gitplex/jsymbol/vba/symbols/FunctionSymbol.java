...
public class FunctionSymbol extends VbaSymbol
{
	...
	public FunctionSymbol(VbaSymbol parent, String name, TokenPosition position, TokenPosition scope, String kind) {
		super(parent, name, position, scope);
		this.kind = kind;
	}

	public FunctionSymbol(VbaSymbol parent, String name, TokenPosition position, TokenPosition scope)
	{
		super(parent, name, position, scope);
