...
public class StructSymbol extends CSymbol {

	private static final long serialVersionUID = 1L;
	
	public StructSymbol(CSymbol parent, String name, boolean local, TokenPosition position, 
			TokenPosition scope) {
	...
	public Image renderIcon(String componentId) {
		Image icon = new NoAntiCacheImage(componentId, 
            		new PackageResourceReference(IconLocator.class, "struct_obj.gif"));
