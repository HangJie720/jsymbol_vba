...
public class EnumSymbol extends CSymbol {

	private static final long serialVersionUID = 1L;
	
	public EnumSymbol(CSymbol parent, String name, boolean local, TokenPosition position, 
			TokenPosition scope) {
	...
	public Image renderIcon(String componentId) {
		Image icon = new NoAntiCacheImage(componentId, 
            		new PackageResourceReference(IconLocator.class, "enum_obj.gif"));
